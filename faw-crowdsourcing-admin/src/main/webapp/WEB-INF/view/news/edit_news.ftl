...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" lang="zh-CN">
	<head>
		<meta charset="utf-8" />
		<title><@layout.globalTitle />编辑新闻</title>
		<@layout.globalMeta />
		<@layout.globalCss />
                ...
                <div class="frame-page">
                    <div class="frame-main">
                        <div class="frame-main-hd">
                            <h3 class="frame-title"style="padding-left:16px;">编辑新闻</h3>
                        </div>
                        <div class="frame-main-bd">
	                        <form class="form-body" id="editNewsForm" action="${webServer}/news/edit/${news.id}" method="POST">
<div class="form-item">
...
<div class="form-item">
    ...
    <div class="form-entity">
        <div class="form-field">
            <input class="form-ipt" type="text" name="newsTitle" value="${news.newsTitle}" placeholder="请输入新闻标题" maxlength="100" />
        </div>
    </div>
</div>
...
<div class="form-item">
    ...
    //新闻回显
     ue.ready(function()
　　　　　　{
　　　　　　　　ue.setContent('${news.newsDesc}');
　　　　　　});
    
		//DOM READY
        $(function() {
		
			$("#editNewsForm").validate(editNewsRules);
