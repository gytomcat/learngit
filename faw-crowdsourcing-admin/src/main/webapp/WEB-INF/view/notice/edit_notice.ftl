<div class="dialog-box dialog-box-form">
    <form class="dialog-content" action="${webServer}/notice/edit">
    	<input type="hidden" name="id" value="${notice.id}" />
        <div class="dialog-head">
            <a class="dialog-close-btn" href="javascript:;">×</a>
            <h4 class="dialog-title">编辑公告</h4>
        </div>
...
<div class="form-item">
    ...
    <div class="form-entity">
        <div class="form-field">
            <input class="form-ipt" type="text" name="noticeTitle" value="${notice.noticeTitle}" placeholder="请输入通知标题" maxlength="100" />
        </div>
    </div>
</div>
<div class="form-item">
    ...
    <div class="form-entity">
        <div class="form-field">
             <textarea class="form-ta" type="text" name="noticeDesc"  placeholder="请输入通知内容" maxlength="2000" >${notice.noticeDesc}</textarea>
        </div>
    </div>
</div>
<div class="form-item">
